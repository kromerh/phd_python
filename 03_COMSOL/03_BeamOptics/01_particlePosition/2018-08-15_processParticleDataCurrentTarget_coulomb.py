...
# check if there is a difference between particle-particle interaction (coulomb force) or not
...
COMSOL_data_file = '{}disc_uniform_Lplasma_0.4_coulomb.csv'.format(COMSOL_data_file_path)  # change this to each filename, i.e. loop

# # without coulomb interaction
# COMSOL_data_file = '{}disc_uniform_Lplasma_0.4_no_coulomb.csv'.format(COMSOL_data_file_path)  # change this to each filename, i.e. loop
...
filename =  '{}/2D_histogram'.format(directory)
