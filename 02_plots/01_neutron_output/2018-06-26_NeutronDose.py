...
df_dose['dose_corr'] = df_dose['dose_corrected']
...
ax2 = ax1.twinx()
df1 = df[ df.index > timeThreshold ] 
ax2.plot(df1.index, df1['HV_current'], 'x',color="darkblue", markersize=5,  alpha=0.65, markeredgewidth=1.5, markeredgecolor='darkblue')
ax2.set_ylabel(r'\textbf{I [mA]}', fontsize=12, color='darkblue')
...
# print(df)
df1 = df[ df.index > timeThreshold ] 
ax1.plot(df1.index, df1['output'], 'o',color="darkblue", markersize=5,  alpha=0.65, markeredgewidth=1.5, markeredgecolor='darkblue')
