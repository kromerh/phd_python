...
master_dir = 'D:/neutron_emitting_spotsize/check_source_gauss_larger/'   # 2018-09-04
...
master_folder = '//fs03/LTH_Neutimag/hkromer/10_Experiments/02_MCNP/neutron_emitting_spot/2_case_files/_experiment_gauss_20180911/'
...
df.to_csv(f'{master_folder}/df_LookupTable.csv')